...
“睿衡”是面向企业洞察、决策与可信治理的产品品牌：

- **睿**：代表洞察、智慧与人工智能，强调从企业数据和知识中发现价值。
- **衡**：代表平衡、判断、治理与可信，强调决策过程安全、可控、可解释、可审计。

睿衡产品体系以 AI、数据资产、企业知识、智能分析和治理能力为基础，帮助企业连接可信能力、形成业务洞察并辅助决策。

### 睿衡智策（RuiHeng Insight）

**产品定位：企业智能洞察与辅助决策平台。**

睿衡智策面向企业经营分析、知识问答、智能研判和决策辅助场景，统一利用数据、知识与 AI 能力，为业务人员和管理者提供有证据、可追溯的洞察与分析结果。该产品名称替代原 **Apexsoft Insight**。

### 睿衡智联（RuiHeng Nexus）

**产品定位：企业数据与智能能力连接平台。**

睿衡智联负责统一连接和治理企业数据、知识、工具、应用与智能服务，为 AI Agent 提供安全、可信、可控、可观测的能力接入与协同基础。该产品名称替代原 **LiveMCP**，MCP 是其底层能力协议之一，不作为面向客户的主品牌名称。

两条产品线共同构成睿衡体系：睿衡智联提供企业智能能力的连接与治理底座，睿衡智策基于这些可信能力完成企业洞察与辅助决策。
