 ...
 */
final class AnalysisContextPresentationContract {

    static final String VERSION = "analysis_context_presentation.v1";

    private AnalysisContextPresentationContract() {
    }

    static Map<String, Object> semanticView(String datasetReference, Map<String, Object> context) {
