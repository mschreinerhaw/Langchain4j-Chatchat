...
public final class AgentPlanBudgetPolicy {
    ...
    public static BudgetCaps fromRuntimeAttributes(Map<String, Object> runtimeAttributes) {
    ...
    public record BudgetCaps(Integer maxSteps, Double costBudget, Integer latencyBudgetMs) {
    ...
    public record ApplyResult(InterpretationPlan plan, boolean adjusted) {
    }
}
