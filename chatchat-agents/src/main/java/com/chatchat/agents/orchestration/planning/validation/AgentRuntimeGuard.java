 ...
 */
public class AgentRuntimeGuard {
    ...
    public AgentRuntimeGuard(int defaultMaxSteps,
    ...
    public BooleanSupplier cancellationCheck(Map<String, Object> runtimeAttributes) {
    ...
    public Map<String, Object> attributesWithDeadline(Map<String, Object> runtimeAttributes) {
    ...
    public long remainingTimeMs(Map<String, Object> runtimeAttributes) {
        long deadlineAt = runtimeLong(
            runtimeAttributes == null ? null : runtimeAttributes.get(deadlineAtAttribute), 0L);
        return deadlineAt <= 0L ? -1L : Math.max(0L, deadlineAt - System.currentTimeMillis());
    }

    public int maxSteps(Map<String, Object> runtimeAttributes) {
    ...
    public boolean hasConfiguredMaxSteps(Map<String, Object> runtimeAttributes) {
    ...
    public int maxToolCalls(Map<String, Object> runtimeAttributes) {
    ...
    public long runtimeLong(Object value, long defaultValue) {
    ...
    public void checkCancelled(BooleanSupplier cancellationCheck) {
