...
public final class ToolCallFingerprint {
    ...
    public static List<String> forPlan(InterpretationPlan plan) {
    ...
    public static boolean materiallyEquivalent(InterpretationPlan first, InterpretationPlan second) {
