...
public class PythonAssetEntity {
    ...
    @Column(name = "mcp_environment_id", length = 64, nullable = false)
    private String mcpEnvironmentId;
    @Column(name = "mcp_environment_version", nullable = false)
    private int mcpEnvironmentVersion;
    @Column(name = "docker_image", length = 300, nullable = false)
    private String dockerImage;
    @Column(name = "python_version", length = 32)
    private String pythonVersion;
    @Column(length = 24, nullable = false)
    private String status;
    @Column(name = "container_name", length = 128)
    private String containerName;
    @Column(name = "workspace_path", length = 600)
    private String workspacePath;
    @Column(name = "cpu_limit", length = 24)
    private String cpuLimit;
    @Column(name = "memory_limit", length = 24)
    private String memoryLimit;
    @Column(name = "disk_limit", length = 24)
    private String diskLimit;
    @Column(name = "timeout_seconds")
    private Integer timeoutSeconds;
    @Column(name = "runtime_user", length = 64)
    private String runtimeUser;
    @Column(name = "network_policy", length = 24)
