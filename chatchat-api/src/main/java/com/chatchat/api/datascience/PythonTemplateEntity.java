...
public class PythonTemplateEntity {
    ...
    @Column(name = "runtime_status", length = 24, nullable = false)
    private String runtimeStatus;
    @Column(name = "mcp_sync_status", length = 24, nullable = false)
    private String mcpSyncStatus;
    @Column(name = "mcp_sync_message", length = 1000)
    private String mcpSyncMessage;
