...
class DatabaseSchemaGeneratorTest {
    ...
    void generateApiSchemasFromJpaEntities() throws Exception {
        ...
        assertSchemaMatches(output.resolve("chatchat-api-mysql.sql"), Path.of("..", "database", "init", "mysql", "chatchat-api.sql"), 74);
        assertSchemaMatches(output.resolve("chatchat-api-h2.sql"), Path.of("..", "database", "init", "h2", "chatchat-api.sql"), 74);
    }
