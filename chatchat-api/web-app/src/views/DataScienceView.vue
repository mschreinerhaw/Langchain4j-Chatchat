<template>
  <section class="ds-page">
    <header class="ds-header">
      <div><span>能力管理 / 数据科学</span><h1>Python 数据科学工作台</h1><p>在专属 Docker Asset 中开发、调试并发布可供 Agent 检索的 Python 能力。</p></div>
