...
import com.chatchat.chat.task.notification.NotificationPolicyEvaluator;

import com.chatchat.chat.task.notification.NotificationContentFormatter;
...
import com.chatchat.chat.task.schedule.ScheduledTaskRepository;

import com.chatchat.chat.task.schedule.ScheduledTaskEntity;

import com.chatchat.chat.task.schedule.ScheduledAgentTaskRequest;

import com.chatchat.chat.task.schedule.AgentScheduleWindowPolicy;
...
class AgentScheduledTaskServiceTest {
    ...
    void stopCurrentRunCancelsOnlyExecutionAndKeepsRecurringScheduleActive() {
        ...
        AgentScheduledTaskService service = new AgentScheduledTaskService(
            ...
            new AgentTaskProperties(), mock(McpTradingCalendarPort.class), mock(McpNotificationPort.class),
    ...
    void terminalTaskEventImmediatelyReconcilesScheduledRunAndSchedule() {
        ...
        AgentScheduledTaskService service = new AgentScheduledTaskService(
            ...
            mock(McpTradingCalendarPort.class),
    ...
    void conditionalNotificationSkipsDispatchAndPersistsVerifiedDecision() {
        ...
        AgentScheduledTaskService service = new AgentScheduledTaskService(
            repository, runRepository, latestRepository, taskService, new ObjectMapper(),
            new AgentTaskProperties(), mock(McpTradingCalendarPort.class), notificationClient,
