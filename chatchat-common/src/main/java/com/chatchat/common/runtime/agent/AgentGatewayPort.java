...
public interface AgentGatewayPort extends RuntimeProtocolPort {
    ...
    default AgentExecutionOutcome resume(AgentDescriptor agent, AgentExecutionRequest request) {
        throw new UnsupportedOperationException("agent task resumption is not supported");
    }
