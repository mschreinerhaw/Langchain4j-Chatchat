...
import com.chatchat.common.runtime.summary.analysis.model.DataAnalysisExecutionStep;
...
public interface DataAnalysisParticipant<M, W extends DataAnalysisWork, R>
    ...
    List<DataAnalysisExecutionStep> EXECUTION_STEPS = DataAnalysisExecutionStep.procedure();
