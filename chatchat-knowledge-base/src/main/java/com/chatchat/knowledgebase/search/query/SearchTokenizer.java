...
public class SearchTokenizer {
     ...
     */
    public List<String> searchTokens(String text) {
     ...
     */
    public List<String> tokenizeOccurrences(String text) {
     ...
     * @return the operation result
     */
    public List<String> normalizeTerms(List<String> values) {
     ...
     * @return the operation result
     */
    public List<String> splitFilter(String value) {
     ...
     * @return the operation result
     */
    public String normalizeExactTerm(String value) {
     ...
     */
    public boolean isSearchNoiseToken(String token) {
