...
@RequestMapping("/api/v1/api-services/categories")
public class ApiServiceCategoryAdminController {
    ...
    private BusinessCategory entity(String id, CategoryRequest request) {
        ...
        category.setKeywordsJson(ModelProtocolJson.compact(request.keywords() == null ? List.of() : request.keywords()));
    ...
    private CategoryView view(BusinessCategory category) {
        ...
        return new CategoryView(category.getId(), category.getCode(), category.getName(),
            category.getDescription(), keywords, category.getSortOrder(), category.isEnabled());
    }

    public record CategoryRequest(String code, String name, String description,
                                  List<String> keywords, Integer sortOrder, Boolean enabled) {}
    public record CategoryView(String id, String code, String name, String description,
