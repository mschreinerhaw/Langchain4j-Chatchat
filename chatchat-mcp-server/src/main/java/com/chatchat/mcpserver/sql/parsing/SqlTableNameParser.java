package com.chatchat.mcpserver.sql.parsing;

public final class SqlTableNameParser {

    private SqlTableNameParser() {
    }

    public static QualifiedTable parse(String tableName, String database) {
    ...
    public record QualifiedTable(String database, String schema, String table) {
    }
}
