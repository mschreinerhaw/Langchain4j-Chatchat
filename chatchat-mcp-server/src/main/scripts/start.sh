...
if [ -n "$SEARCH_ENGINE" ]; then
  ...
  case "$SEARCH_ENGINE_NORMALIZED" in
    lucene)
      export CHATCHAT_SEARCH_ENGINE="lucene"
      export CHATCHAT_MCP_LUCENE_ENGINE="lucene"
      ;;
    opensearch|open-search)
      export CHATCHAT_SEARCH_ENGINE="opensearch"
      export CHATCHAT_MCP_LUCENE_ENGINE="opensearch"
      ;;
    *)
