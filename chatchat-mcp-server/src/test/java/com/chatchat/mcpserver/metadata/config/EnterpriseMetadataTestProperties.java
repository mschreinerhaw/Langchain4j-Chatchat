package com.chatchat.mcpserver.metadata.config;
...
public final class EnterpriseMetadataTestProperties {

    private EnterpriseMetadataTestProperties() {
    }

    public static MetadataGovernancePolicyService policyService() {
    ...
    public static MetadataGovernancePolicy policy() {
