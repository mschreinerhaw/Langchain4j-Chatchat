  ...
  computed: {
    ...
    sqlFields() {
      return [
        ...
        { key: 'allowedTemplatesJson', label: '允许 SQL 运维模板', type: 'templatePicker', itemKey: 'code', items: () => this.sqlOpsTemplates, span: 'col-12', help: '从已维护的 SQL 运维模板中筛选并勾选，保存时自动生成 JSON。' },
