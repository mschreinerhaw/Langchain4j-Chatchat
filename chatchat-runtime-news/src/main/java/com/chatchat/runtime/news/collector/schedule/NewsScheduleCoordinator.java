package com.chatchat.runtime.news.collector.schedule;
...
public class NewsScheduleCoordinator {
    ...
    private final NewsCollectionOperations collectionService;
    ...
    public NewsScheduleCoordinator(NewsSourceRepository repository, NewsCollectionOperations collectionService,
