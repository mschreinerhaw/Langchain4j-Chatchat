    ...
    create index idx_mcp_tool_contract_active on mcp_tool_workflow_contract(tool_id, status);
    create index idx_mcp_tool_contract_checksum on mcp_tool_workflow_contract(contract_checksum);
