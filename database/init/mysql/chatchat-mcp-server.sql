    ...
    create table mcp_livedata_config (
        ...
        cache_ttl_seconds integer not null,
        enabled bit not null,
        expose_ams_token_parameter bit not null,
        include_unpublished_as_disabled bit not null,
        login_enabled bit not null,
        login_timeout_ms integer not null,
        max_apis integer not null,
        overwrite_existing bit not null,
    ...
    create table mcp_notification_channel_config (
        ...
        sms_password_md5 bit,
        smtp_auth_enabled bit,
        smtp_port integer,
        smtp_ssl_enabled bit,
        smtp_starttls_enabled bit,
        timeout_ms integer not null,
        created_at datetime(6) not null,
        updated_at datetime(6) not null,
