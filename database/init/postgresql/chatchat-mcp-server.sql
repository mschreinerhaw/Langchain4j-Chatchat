    ...
    create table mcp_database_query_config (
        ...
        index_tags_json text,
        input_schema_json text,
        routing_labels_json text,
        sql_steps_json text,
    ...
    create table mcp_notification_channel_config (
        ...
        channel varchar(32) not null check (channel in ('EMAIL','SMS','WECHAT_WORK','DINGTALK')),
    ...
    create table mcp_template_query_binding (
        ...
        template_keys_json text not null,
        primary key (id),
